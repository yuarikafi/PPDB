      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title"> Daftar Siswa Baru </h3>
                ...
                <div class="card-body">
                  <div class="col-md-12 order-md-1">
                    ...
                    <form class="needs-validation" action="proses/pros_tambah_baru.php" method="post">
                      ...
                      if (!$result) {
                        die ("query_error: " . mysqli_error($koneksi));
                      }
                      ?>

                      <div class="row">
                      <div clsas="col-md-6 mb-3">
                    ...
                    <div class="row">
                      <div class="col-4">
                        <div class="cuform-control text-white custom-radio">
                          ...
                          <label class="cuform-control " style="color: black;" for="credit">Islam</label>
                        </div>
                      </div>
                      <div class="col-4">
                        <div class="cuform-control text-white custom-radio">
                          <input id="debit" name="agama" type="radio" class="cuform-control text-white-input" required="" value="Kristen">
                          <label class="cuform-control " style="color: black;" for="debit">Kristen</label>
                        </div>
                      </div>
                      <div class="col-4">
                        <div class="cuform-control text-white custom-radio">
                          <input id="paypal" name="agama" type="radio" class="cuform-control text-white-input" required="" value="Katolik">
                          <label class="cuform-control " style="color: black;" for="paypal">Katolik</label>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-4">
                        <div class="cuform-control text-white custom-radio">
                          ...
                          <label class="cuform-control " style="color: black;" for="paypal">Hindu</label>
                        </div>
                      </div>
                      <div class="col-4">
                        <div class="cuform-control text-white custom-radio">
                          <input id="paypal" name="agama" type="radio" class="cuform-control text-white-input" required="" value="Buddha">
                          <label class="cuform-control " style="color: black;" for="paypal">Buddha</label>
                        </div>
                      </div>
                      <div class="col-4">
                        <div class="cuform-control text-white custom-radio">
                          <input id="paypal" name="agama" type="radio" class="cuform-control text-white-input" required="" value="Konghuchu">
                          <label class="cuform-control " style="color: black;" for="paypal">Konghuchu</label>
                        </div>
                      </div>
                    </div>
                  </div>
