                      ...
                      ?>
                        <tbody style="background-color:white;">
                          ...
                          <td style="text-align: center;">
                            ...
                            <a title="hapus" class="btn btn-danger mdi mdi-delete" style="font-size: 10px;" href="proses/proses_hapus.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>&nbsp;
                          </td>
                        </tbody>
                        <!-- Modal -->
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                      ...
                                      <div class="form-inline">
                                        <div class="form-check form-check-inline">
                       <input class="form-check-input" type="radio" name="sebagai" id="inlineRadio1" value="Admin">
                                          <label class="custom-label text-purple" for="inlineRadio1">Admin</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="sebagai" id="inlineRadio2" value="Petugas">
                                          <label class="custom-label text-purple" for="inlineRadio2">Petugas</label>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
