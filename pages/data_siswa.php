                      ...
                      ?>
                        <tbody style="background-color:white;">
                          ...
                          <td style="text-align: center;">
                            <button type="button" class="btn btn-warning " data-toggle="modal"  data-target="#<?php echo $edit_modal_id; ?>">Edit</button>
                            <a title="hapus" class="btn btn-danger " style="font-size: 10px;" href="proses/pros_hapus_siswa.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>&nbsp;
                          </td>
                        </tbody>
                        <!-- Modal -->
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                      ...
                                      <div class="col-md-12 mb-3">
                                         ...
                                         <option <?php if ($row['jurusan'] == 'DESAIN KOMUNIKASI DAN VISUAL') echo 'selected';?>>DESAIN KOMUNIKASI DAN VISUAL</option>
