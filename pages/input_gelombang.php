      ...
      <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="needs-validation" action="proses/pros_nambah_gel.php" method="post">
              <div class="row">
                                ...
                                <form class="needs-validation" action="proses/pros_tambah_gel.php" method="post">
                                  <div class="row">
                                    <div class="col-md-6 mb-3">
                                      ...
                                      <input type="text" class="form-control" name="no_pendaftaran" id="firstName" placeholder="Daftar Disini" value="<?php echo $row['no_pendaftaran']; ?>" required="">
                                      <div class="invalid-feedback">
                                        Valid first name is required.
                                      </div>
                                    </div>
                                    <label for="firstName">Tanggal</label>
                                      <input type="text" class="form-control" name="tanggal" id="firstName" placeholder="Isi Tanggal Hari Ini" value="<?php echo $row['tangal']; ?>" required="">
                                      <div class="invalid-feedback">
                                      </div>
