        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-xl-6 grid-margin stretch-card flex-column">
              ...
              <div class="row h-100">
                <div class="col-md-5 stretch-card grid-margin grid-margin-md-5">
                  <div class="card">
                    <div class="card-body d-flex flex-column justify-content-between">
                      <p class="text-muted">income pendapatan</p>
              ...
              <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <span class="d-block text-center text-sm-left d-sm-inline-block" style="font: size 10px;">Rp.<?php echo $row['total_pengurangan'];?></span>
              </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card-body">
                      <div class="row h-100">
                        <div class="col-8 d-flex flex-column justify-content-between">
                          <p class="text-muted">Jumlah Jurusan</p>
                          <h4>5</h4>
                        </div>
                        <div class="col-8 d-flex flex-column justify-content-between">
                          <p class="text-muted">Jumlah pendaftar</p>
                          <h4><?php echo $row['total_siswa'];?></h4>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-7 stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <div class="row h-100">
                        <div class="col-8 d-flex flex-column justify-content-between">
                          <p class="text-muted">Income Perhari</p>
                          <h4><?php echo number_format($total_income,0,',','.');?></h4>
                        </div>
                      </div>
                    </div>
                  </div>
